...
- [x] แก้ `seed-hr.html`: adminRole ของ **นางพิไลวรรณ จันต๊ะตา** และ **น.ส.ณัฏฐกานต์ มุกดาจตุรพักตร์**
      เปลี่ยนจากชื่อตำแหน่งหัวหน้างาน → `'ว่าง'` เพราะทั้งคู่เป็นแค่ "รักษาการ" ในตำแหน่งนั้น (ตาม docx ต้นฉบับ)
      ไม่ใช่ผู้ดำรงตำแหน่งตัวจริง — org chart ควรโชว์ "ยังไม่มีผู้ดำรงตำแหน่ง" ไม่ใช่ชื่อคน
      **เขียนทับ Firestore (`hr/personnel`) ให้ตรงกันแล้ว** ผ่าน REST PATCH โดยตรง (2026-09-12) —
      ยืนยันแล้วว่า adminRole ทั้งคู่เป็น 'ว่าง' และจำนวนรายการยังครบ 36 (ไม่มีข้อมูลหาย)
